...
class _WithBuilder extends State<WithBuilder> {
  ...
  List<ItemData> data = [
    ItemData(Colors.blueAccent, "Assets/Icons/赛亚人.png", "Hi", "It's Me", "Sirajul Haq"),
    ItemData(Colors.deepPurpleAccent, "Assets/Icons/OMEN season 3 winter edition.jpg", "Take a", "Look At",
        "Liquid Swipe"),
    ItemData(Colors.green, "Assets/Icons/ninja.jpg", "Liked?", "Fork!", "Give Star!"),
    ItemData(Colors.yellow, "Assets/Icons/denin-lawley-HaziTVzN4CU-unsplash.jpg", "Can be", "Used for",
        "Onboarding design"),
    ItemData(
        Colors.pink, "Assets/Icons/赛亚人.png", "Example", "of a page", "with Gesture"),
    ItemData(Colors.red, "Assets/Icons/denin-lawley-HaziTVzN4CU-unsplash.jpg", "Do", "try it", "Thank you"),
  ];
